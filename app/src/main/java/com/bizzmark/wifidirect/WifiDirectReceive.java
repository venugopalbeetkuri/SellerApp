package com.bizzmark.wifidirect;
...
import com.bizzmark.wifidirect.Adapter.WifiAdapter;
    ...
    private void initReceiver() {
        ...
        WifiP2pManager.ConnectionInfoListener mInfoListener = new WifiP2pManager.ConnectionInfoListener() {
            ...
            public void onConnectionInfoAvailable(WifiP2pInfo minfo) {
                ...
                Toast.makeText(getApplicationContext(),"Ask customer to send request.",Toast.LENGTH_SHORT).show();
